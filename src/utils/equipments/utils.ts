...
// accessory: EQUIPMENT_IDS.accessory.reduce<ComputedEquipment[]>((acc, id) => {
//   const name = EQUIPMENT_NAMES[id]
...
const sortEquipmentNames = (category: Equipment, lang: "fr" | "en") => {
  return EQUIPMENT_IDS[category].map((id: number) => ({
    value: id.toString(),
  ...
  // return EQUIPMENT_IDS[category].reduce<ComputedEquipment[]>((acc, id) => {
  //   const value = id.toString();
  //   const label = EQUIPMENT_NAMES[id][lang];
  ...
  //   return [...acc, result, lastElement]
  //   // const clone = [...acc].splice(acc.length - 1, 0, result);
  //   // return clone;
  // }, []);
};
...
// export const SORTED_EQUIPMENT_NAMES_FR: Record<
//   Equipment,
//   ComputedEquipment[]
// > = {
//   accessory: sortEquipmentNames('accessory', 'fr'),
...
// export const SORTED_EQUIPMENT_NAMES_EN: Record<
//   Equipment,
//   ComputedEquipment[]
// > = {
//   accessory: sortEquipmentNames('accessory', 'en'),
